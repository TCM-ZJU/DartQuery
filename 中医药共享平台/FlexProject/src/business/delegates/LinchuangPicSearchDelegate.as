package business.delegates
{
	...
	public class LinchuangPicSearchDelegate
	{
		private var serviceLocator:ServiceLocator = ServiceLocator.getInstance();
		private var _service:HTTPService;
		private var _responder:IResponder;
		
		public function LinchuangPicSearchDelegate(responder:IResponder)
		{
			_service = serviceLocator.getHTTPService("linchuangPicSearchService");
